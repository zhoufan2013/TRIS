...
public final class ReportMetadata
{
    ...
    static final String DEFAULT_TITLE = "TRIS Test Report";
     ...
     * returns null.
     * @return A {@link java.io.File} pointing to the stylesheet, or null if no stylesheet
     * is specified.
     */
     ...
     * test machine.
     * @throws java.net.UnknownHostException If there is a problem accessing the machine's host name.
     */
