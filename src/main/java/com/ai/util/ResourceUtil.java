...
public class ResourceUtil {
	 ...
	 * @throws Exception
	 */
	public static InputStream loadInputStreamFromFilepath(String file_path) {
	 ...
	 * @throws Exception
	 */
	public static String readCfgFile(String file_path, String encoding) throws IOException {
